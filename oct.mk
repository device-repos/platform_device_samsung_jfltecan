...
PRODUCT_BUILD_PROP_OVERRIDES += PRODUCT_NAME=jfltecan TARGET_DEVICE=jfltecan BUILD_FINGERPRINT="samsung/oct_jfltecan/jfltecan:4.4/KRT16M/user/release-keys" PRIVATE_BUILD_DESC="jfltecan-user 4.4 KRT16M release-keys"
